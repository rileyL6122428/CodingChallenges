...
INSERT INTO coding_challenge (id, date_created, name, difficulty, description, method_signature) VALUES (2, '2002-01-01', 'reverse string', 'easy', 'Write a function "reverseString" that takes a string and returns a string with its characters order reversed.', 'String reverseString(String string)')
INSERT INTO coding_challenge_parameter_types (challenge_id, parameter_type_id) VALUES (2, 3)

INSERT INTO coding_challenge (id, date_created, name, difficulty, description, method_signature) VALUES (3, '2003-01-01', 'concat strings', 'easy', 'Write a function "concatStrings" that takes an array of strings and returns a string. The returned string should be all of the strings concatenated.', 'String concatStrings(String[] strings)')
INSERT INTO coding_challenge_parameter_types (challenge_id, parameter_type_id) VALUES (3, 4)

INSERT INTO coding_challenge (id, date_created, name, difficulty, description, method_signature) VALUES (4, '2004-01-01', 'character count', 'easy', 'Write a function "characterCount" that takes a char and a string. Return the number of occurrences of the character in the string.', 'int characterCount(char character, String string)')
INSERT INTO coding_challenge_parameter_types (challenge_id, parameter_type_id) VALUES (4, 2)
INSERT INTO coding_challenge_parameter_types (challenge_id, parameter_type_id) VALUES (4, 4)
